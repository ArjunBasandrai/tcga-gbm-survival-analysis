...
def perform_mutation_km_analysis(mutation_data: MutationData):
    ...
    kaplan_meier_analysis(mutation_data(), output_dir, mutation_data.label_mappings)
...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description="Perform Survival Analysis on TCGA-GBM dataset.")
